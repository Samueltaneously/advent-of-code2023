...
const dataFormator = (data) => {
    ...
    let formattedData = (data.trim().split('\n'));
...
// raw data is a grid (it has the same width for each line)
// so for checking for diagonals could check the same indecies
// of a number for previous or following lines/array

// loop through each line/part of array
// if number found, pull full number's indecies
// check indecies of line/part before and after current for symbol
